<script lang="ts">
	...
	function handleSelectFavorite(e: FocusEvent & { currentTarget: EventTarget & HTMLSelectElement }) {
...
<div class="group">
	<button class:clicked class:favorited on:click={favoriteComic} title="favorite" class="star" id="star" />
...
<style>
	...
	.star {
		...
		clip-path: polygon(50% 0%, 64% 32%, 98% 35%, 73% 59%, 79% 91%, 50% 74%, 21% 91%, 28% 58%, 2% 35%, 35% 32%);
		display: inline-flex;
